...
from mlflow.utils.mlflow_tags import KIWI_SYSTEM_HW_CPU, KIWI_SYSTEM_HW_MEMORY, KIWI_SYSTEM_HW_DISK, \
...
def _get_gpu_info():
    ...
    device_num = 0
    try:
        device_num = len(torch.cuda.current_device())
    ...
    elif (len(tf.test.gpu_device_name())>0):
        # Using TensorFlow
