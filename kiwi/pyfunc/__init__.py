...
import kiwi.pyfunc.utils
from kiwi.models import Model, ModelSignature, ModelInputExample
from kiwi.models.model import MLMODEL_FILE_NAME
from kiwi.models.utils import _save_example
from kiwi.pyfunc.model import PythonModel, PythonModelContext, get_default_conda_env
from kiwi.tracking.artifact_utils import _download_artifact_from_uri
from kiwi.types import DataType, Schema
from kiwi.utils import PYTHON_VERSION, deprecated, get_major_minor_py_version
from kiwi.utils.file_utils import TempDir, _copy_file_or_tree
...
def load_model(model_uri: str, suppress_warnings: bool = True) -> PyFuncModel:
    ...
    if CODE in conf and conf[CODE]:
        ...
        kiwi.pyfunc.utils._add_code_to_system_path(code_path=code_path)
...
def save_model(path, loader_module=None, data_path=None, code_path=None, conda_env=None,
    ...
    if first_argument_set_specified:
        ...
        return kiwi.pyfunc.model._save_model_with_class_artifacts_params(
