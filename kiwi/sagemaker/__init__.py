...
from kiwi.models.container import SUPPORTED_FLAVORS as SUPPORTED_DEPLOYMENT_FLAVORS
from kiwi.models.container import DEPLOYMENT_CONFIG_KEY_FLAVOR_NAME
...
def _get_default_image_url(region_name):
    ...
    return (repository_conf["repositoryUri"] + ":{version}").format(version=kiwi.version.VERSION)
