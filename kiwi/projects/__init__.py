...
import kiwi.projects.databricks
import kiwi.tracking as tracking
from kiwi.entities import RunStatus
from kiwi.exceptions import ExecutionException, MlflowException
from kiwi.projects.submitted_run import LocalSubmittedRun, SubmittedRun
...
from kiwi.tracking.context.git_context import _get_git_commit
...
from kiwi.utils import databricks_utils, file_utils, process
from kiwi.utils.file_utils import path_to_local_sqlite_uri, path_to_local_file_uri
...
def run(uri, entry_point="main", version=None, parameters=None,
    ...
    if backend == "databricks":
        kiwi.projects.databricks.before_run_validations(kiwi.get_tracking_uri(), backend_config)
...
def _run_entry_point(command, work_dir, experiment_id, run_id):
    ...
    env.update(_get_databricks_env_vars(tracking_uri=kiwi.get_tracking_uri()))
...
def _invoke_mlflow_run_subprocess(
    ...
    env_vars.update(_get_databricks_env_vars(kiwi.get_tracking_uri()))
