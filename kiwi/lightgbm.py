...
def log_model(lgb_model, artifact_path, conda_env=None, registered_model_name=None,
    ...
    """
    Model.log(artifact_path=artifact_path, flavor=kiwi.lightgbm,
...
def autolog():
    ...
    def train(*args, **kwargs):
        ...
        if early_stopping:
            ...
            try_mlflow_log(kiwi.log_metric, 'stopped_iteration', len(eval_results))
            ...
            try_mlflow_log(kiwi.log_metrics, eval_results[model.best_iteration - 1],
                           step=extra_step)
