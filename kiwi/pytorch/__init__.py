...
def log_model(pytorch_model, artifact_path, conda_env=None, code_paths=None,
    ...
    Model.log(artifact_path=artifact_path, flavor=kiwi.pytorch, pytorch_model=pytorch_model,
